...
import { miscellaneousGallery, getAllImagesRandom } from '../utils/galleryImports';

const MiscellaneousGallery: React.FC = () => {
  // Get all images in random order for the full gallery page
  const randomizedImages = useMemo(() => getAllImagesRandom(miscellaneousGallery), []);
      ...
      <div className="px-4 sm:px-8 lg:px-40 flex justify-center py-8 lg:py-12">
        <div className="flex flex-col max-w-[960px] w-full">
          ...
          <p className="text-[#141414] text-base sm:text-lg font-normal leading-normal pb-8 pt-1 px-4 text-center max-w-4xl mx-auto">
            Life's beautiful spontaneous moments that don't fit in a box but capture the heart perfectly. 
            From creative experiments to unexpected discoveries, these images celebrate the art of seeing beauty everywhere.
          </p>
        </div>
      </div>
        ...
        <div className="px-4 sm:px-8 lg:px-40">
          <div className="max-w-[960px] mx-auto text-center">
            ...
            <p className="text-[#141414] text-base sm:text-lg leading-relaxed mb-8 max-w-2xl mx-auto">
              Sometimes the best shots come from the most unexpected moments. Let's collaborate on something 
              creative and capture images that tell your unique story in your own distinctive way.
            </p>
