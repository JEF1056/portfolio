      ...
      <div className="px-4 sm:px-8 lg:px-40 flex justify-center py-6 lg:py-8">
        <div className="flex flex-col max-w-[960px] w-full">
          ...
          <p className="text-[#141414] text-base sm:text-lg font-normal leading-normal pb-6 pt-1 px-4 text-center max-w-4xl mx-auto">
            Capturing life's most precious celebrations and milestones. From
            intimate gatherings to grand occasions, I document the authentic
            emotions, connections, and memories that make each event uniquely
            yours.
          </p>
        </div>
      </div>
        ...
        <div className="px-4 sm:px-8 lg:px-40">
          <div className="max-w-[960px] mx-auto text-center">
            ...
            <p className="text-[#141414] text-base sm:text-lg leading-relaxed mb-8 max-w-2xl mx-auto">
              Let me help you preserve every precious moment. Whether it's a
              wedding, birthday, corporate event, or family celebration, I'll
              capture the joy and emotion that makes your event unforgettable.
            </p>
            <Link
              to="/contact"
