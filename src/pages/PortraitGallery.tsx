    ...
    <div className="px-4 md:px-20 lg:px-40 flex flex-1 justify-center py-5">
      <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
        <div className="mb-6 md:mb-8">
          <h1 className="text-2xl md:text-3xl font-bold text-[#141414] mb-4">Portrait Photography</h1>
          <p className="text-[#757575] text-base md:text-lg">
            Professional portrait photography that captures personality, emotion, and authentic moments.
          </p>
        </div>
