        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[400px] lg:min-h-[500px]">
          ...
          <div className="flex flex-col justify-center space-y-6 animate-fade-in-left">
            <div className="space-y-4">
              <h1 className="text-6xl font-bold text-[#141414] leading-tight animate-slide-up">
                Jess Fan
              </h1>
            ...
            <div className="space-y-4 animate-fade-in-up animation-delay-300">
              <h2 className="text-2xl font-medium text-[#757575] leading-relaxed">
                Photographer & Visual Storyteller
              </h2>
              <p className="text-lg text-[#757575] leading-relaxed max-w-md">
            ...
            <div className="relative group">
              ...
              <div className="relative z-10 overflow-hidden rounded-2xl shadow-2xl transform group-hover:scale-105 transition-transform duration-500">
                <img 
                  ...
                  className="w-80 h-96 object-cover animate-gentle-zoom"
                />
